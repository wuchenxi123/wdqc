...
/*	      columnDefs: [ {
	      ...
	      fnRowCallback : function(nRow,aData,iDataIndex){			    	  
			   	...
			   	var editPage = ctx + '/admin/pages/education/course/add.jsp';
			   	var Delete = ctx + '/cou_Del.ac';
				...
				html = html + '<a class="btn" onclick="$.page.del(\'' +Delete+ '?ids=' + aData.coId + '\');"> <i class="fa fa-times"></i> 删除</a>';
				html = html + '</div>';
