...
<script src="<%=ctx %>/admin/pages/business/sign/list.js" type="text/javascript" ></script>
							...
							<form class="form-horizontal">
								<div class="col-sm-9">
									<div class="form-group">
										<label class="col-sm-4 control-label">资询人名：</label>
										<div class="col-sm-3">
											<input name="param._sk_stName" id="param._sk_stName" type="text" class="form-control" placeholder="按用户名模糊查询">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-4 control-label">手机：</label>
										<div class="col-sm-3">
											<input name="param._sk_stMoblie" id="param._sk_stMoblie" type="text" class="form-control" placeholder="按手机模糊查询">
										</div>
									</div>
								</div>
								<div class="col-sm-3">
