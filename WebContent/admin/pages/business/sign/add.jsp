...
<script src="<%=ctx%>/admin/pages/business/sign/add.js"
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div id="myTabContent" class="tab-content ">
				<div id="info" class="tab-pane fade in active">
					<form role="form" class="form-horizontal">
						<input type="hidden" name="form.stId" id="form.stId" /> <input
							...
							type="hidden" name="form.stStatus" id="form.stStatus" value="0" /> <input type="hidden" name="form.creator" id="form.creator"
							...
							id="form.cltSum" type="text" class="form-control hidden"> <input
							name="form.cltApply" id="form.cltApply" type="text"
							class="form-control hidden" value="0"> <input name="form.cltId"
							id="form.cltId" type="text" class="form-control hidden"> <input
										...
										<div class="box box-primary">
											<div class="box-body">
												...
												<div class="col-sm-4" style="margin-top: 45px;">
													<div class="box-footer nav nav-tabs text-center pull-right"
														id="myTab">
														<!-- <button class="btn btn-primary fa fa-floppy-o" onclick="$.page.config.fnSave();">保存</button> -->
														<a href="#fileup" data-toggle="tab"
															class="btn btn-primary btn-lg btn-block"
															onclick="$.page.config.fnSave();"> <i
				...
				<div class="tab-pane fade" id="fileup">
					<div class="panel panel-primary">
						<div class="panel-heading">
						...
						<div class="panel-body">
								...
								<div class="form-group" id="material">
									...
									<div class="col-sm-8">
										<select class="form-control" name="cltSaletextbookid"
											id="cltSaletextbookid" onchange="cltSaleid(this[selectedIndex].value);">
							...
							<div class="col-sm-12">
								<div class="col-xs-2 col-xs-offset-8 text-danger">
									<div>
